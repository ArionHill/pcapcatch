...
class ApkManagerThread(threading.Thread):
    #存放apk的路径
    apkStoreFolderRel = './PcapCatch/ApkStore/'
    #等待分析的apk路径
    apkWaitFolderRel = "./PcapCatch/ApkWait/"
    #正在分析的apk路径
    apkAnalyzingFolderRel = "./PcapCatch/ApkAnalyzing/"
    #apk分析log路径
    apkLogFolderRel = "./PcapCatch/ApkLog/"
    #出bug次数大于3次的apk存放路径
    apkErrorFolderRel = "./PcapCatch/ApkError/"
